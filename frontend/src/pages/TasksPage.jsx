  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] py-10 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {overdueTasks > 0 && (
          <div className="rounded-2xl border border-rose-200 bg-rose-50 p-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="text-xs sm:text-sm">
                ...
                <span className="text-rose-600 hidden sm:inline ml-1">
            ...
            <button
              ...
              className="px-3 py-1 rounded-lg bg-rose-600 hover:bg-rose-700 text-white text-xs font-medium transition-colors cursor-pointer shrink-0"
            >
              View Overdue
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          <div className="bg-white rounded-2xl p-4 border border-slate-200 text-center shadow-xs">
            <span className="text-xs text-slate-500 block mb-1">Total Tasks</span>
            <span className="text-xl sm:text-2xl font-bold text-slate-900">{totalTasks}</span>
          </div>
          <div className="bg-white rounded-2xl p-4 border border-slate-200 text-center shadow-xs">
            <span className="text-xs text-slate-500 block mb-1">To Do</span>
            <span className="text-xl sm:text-2xl font-bold text-slate-700">{todoTasks}</span>
          </div>
          <div className="bg-white rounded-2xl p-4 border border-slate-200 text-center shadow-xs">
            <span className="text-xs text-amber-700 block mb-1">In Progress</span>
            <span className="text-xl sm:text-2xl font-bold text-amber-600">{inProgressTasks}</span>
          </div>
          <div className="bg-white rounded-2xl p-4 border border-slate-200 text-center shadow-xs">
            <span className="text-xs text-emerald-700 block mb-1">Completed</span>
            <span className="text-xl sm:text-2xl font-bold text-emerald-600">{completedTasks}</span>
          </div>
          <div className="bg-white rounded-2xl p-4 border border-slate-200 text-center shadow-xs col-span-2 sm:col-span-1">
            <span className="text-xs text-rose-700 block mb-1">Overdue</span>
            <span className={`text-xl sm:text-2xl font-bold ${overdueTasks > 0 ? 'text-rose-600' : 'text-slate-400'}`}>
              {overdueTasks}
            </span>
          </div>
        </div>
        ...
        {!loading && !error && tasks.length === 0 && (
          <div className="bg-white rounded-3xl p-12 border border-slate-200 text-center max-w-md mx-auto space-y-3 shadow-xs">
            ...
            <h3 className="text-base font-bold text-slate-900">No Tasks Created Yet</h3>
            ...
            <div className="pt-2">
              {projects.length === 0 ? (
                <a
                  href="/projects"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium transition-colors shadow-xs"
                >

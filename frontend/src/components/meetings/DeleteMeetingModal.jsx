      ...
      <div className="bg-white max-w-md w-full rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-2xl space-y-5">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            Are you sure you want to permanently cancel and delete <strong className="text-slate-900">"{meetingTitle}"</strong>? All associated attendee records and meeting minutes will also be deleted.
          </p>
        </div>
